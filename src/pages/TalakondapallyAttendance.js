...
import { FiCalendar, FiRefreshCw, FiUserPlus } from "react-icons/fi"; // <-- ADDED ICONS
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <header className="sticky top-0 z-20 bg-white/95 backdrop-blur border-b border-gray-200">
          ...
          <div className="px-4 py-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button 
                ...
                aria-label="Refresh" 
                title="Refresh" 
                className="rounded-lg p-2 border border-gray-300 bg-white hover:bg-gray-50"
              >
                <FiRefreshCw />
              </button>
              {/* Add Button */}
              <button 
                ...
                title="Add employee" 
                className={`rounded-lg p-2 ${readOnly ? "bg-gray-200 text-gray-500 cursor-not-allowed" : `${PRIMARY_BTN} text-white`}`}
              >
                <FiUserPlus />
              </button>
            </div>
          ...
          {/* Second Bar: Counts, Submitted Pill, Logout */}
          <div className="px-4 pb-3 flex items-center justify-between gap-3">
            {/* Quick counts */}
            <div className="text-xs text-gray-700 flex items-center gap-3 overflow-x-auto">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              {/* Submitted Pill (from original Talakondapally) */}
              {submitted ? (
